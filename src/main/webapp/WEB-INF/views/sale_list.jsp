...
<div class="sale">
	...
	<input type="text" name="startDt" id="startDate" title="시작일" maxlength="10" value="${sDate}" readonly style="width: 200px;height: 30px;">
	<span>~</span>
	<input type="text" name="endDt" id="endDate" title="시작일" maxlength="10" value="${eDate}" readonly style="width: 200px;height: 30px;">
	<select id="dateCond">
