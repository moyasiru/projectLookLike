...
<script>
	...
	$(document).ready(function() {
	    ...
	    $("form").submit(function(event) {
	        ...
	        var content = $("input[name='qna_content']").val();
...
<%-- 		    <input type="hidden" name="qna_imgpath" value="${qna_imgpath}"> --%>
...
<!-- 			        <img src="C:\upload\temp\2023-06-21\afa2736b88a2423aa4fe926033127a9c.png" alt="이미지"> -->
	...
	<script type="text/javascript">
		console.log("@# content_view.qna_key ==> "+${content_view.qna_key});
		console.log("@# content_view.qna_hit ==> "+${content_view.qna_hit});
		console.log("@# content_view.qna_title ==> "+${content_view.qna_title});
		console.log("@# content_view.qna_content ==> "+${content_view.qna_content});
		console.log("@# qna_imgpath ==> "+${qna_imgpath});
